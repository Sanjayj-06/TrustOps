...
import TrustOpsDashboard from "../components/TrustOpsDashboard";
...
const NAV_SECTIONS = [
  ...
  { id: "architecture", label: "Workflow", icon: Info },
...
export default function App() {
  ...
  // allMetricsRows is now computed inside TrustOpsDashboard
  ...
  return (
    <div className="min-h-screen bg-dot-grid">
      ...
      <main className="max-w-7xl mx-auto px-5 pt-4 pb-10 space-y-10">
        ...
        {/* Results Phase — TrustOps Dashboard */}
        {state.phase === "results" && eval_ && state.sessionId && (
          <section
            id="results"
            ref={(el) => {
          ...
          >
            <TrustOpsDashboard
              ...
              filename   = {state.filename || "unknown.py"}
            />
